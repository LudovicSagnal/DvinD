...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 30 jan. 2023 à 16:02
...
CREATE TABLE IF NOT EXISTS `asset` (
  ...
  KEY `fk_allouer_type_asset` (`id_type_asset`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `url_utilisateur` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
--
ALTER TABLE `asset`
  ADD CONSTRAINT `fk_allouer_type_asset` FOREIGN KEY (`id_type_asset`) REFERENCES `type_asset` (`id_type_asset`);
